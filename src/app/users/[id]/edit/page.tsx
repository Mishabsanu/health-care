  ...
  return (
    <div className="edit-user-container animate-fade-in clinical-form-wide" style={{ paddingBottom: '7rem' }}>
      <div style={{ marginBottom: '3rem' }}>
        <button onClick={() => router.back()} style={{ marginBottom: '1.5rem', color: 'var(--primary)', fontSize: '0.9rem', display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: 700, background: 'rgba(15,118,110,0.08)', padding: '0.5rem 1rem', borderRadius: 'var(--radius-sm)' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>Fields marked <span style={{ color: '#ef4444' }}>*</span> are required.</p>
      </div>
