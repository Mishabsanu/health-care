        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }}>
                <div
                    ...
                    style={{ padding: '1.25rem', borderLeft: '4px solid #6366f1', cursor: 'pointer', transition: 'transform 0.2s', background: 'white' }}
                >
                ...
                <div
                    onClick={() => router.push('/appointments')}
                    className="card interactive-card"
                    style={{ padding: '1.25rem', borderLeft: '4px solid #f59e0b', cursor: 'pointer', transition: 'transform 0.2s', background: 'white' }}
                >
